  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="RegistroE.php">RegistroEmleado</a>
        </li>
        <li class="nav-item">
...
<form class="row g-3 needs-validation" novalidate action="controlador/controladorE.php" method="POST">
  <div class="col-md-4">
  ...
  <div class="col-md-4">
    <label for="validationCustomRol" class="form-label">Rol</label>
    <input type="text" class="form-control" id="validationCustomRol" aria-describedby="inputGroupPrepend" required name="rol">
    <div class="invalid-feedback">
      Ingrese su rol
    </div>
    <div class="valid-feedback">
  ...
  <div class="col-12">
    <button class="btn btn-primary form-control" type="submit" id="registro2" name="registro2">Registrarme</button>
  </div>
</form>
